 ...
 */
export const camel = (str: string | null | undefined): string => {
	const parts =
		str
 ...
 */
export const dash = (str: string | null | undefined): string => {
	const parts =
		str
			?.replace(/([A-Z])+/g, capitalize)
			?.split(/(?=[A-Z])|[\.\-\s_]/)
 ...
 */
export const pascal = (str: string | null | undefined): string => {
